...
2g. document findings in a new thoughts document: `thoughts/shared/research/YYYY-MM-DD-TICKET-XXXX-description.md`
...
```
✅ Completed research for TICKET-XXXX: [ticket title]

Research topic: [research topic description]

The research has been:

Created at thoughts/shared/research/YYYY-MM-DD-TICKET-XXXX-description.md
