...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/TICKET-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - TICKET-XXXX is the ticket number (replace with `general` if no ticket)
...
# Handoff: TICKET-XXXX {very concise description}
